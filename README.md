...
[View this README on GitHub.](https://github.com/Infineon/mtb-example-ce241829-dma-descriptor-chain)

[Provide feedback on this code example.](https://cypress.co1.qualtrics.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
The following example clones the "[mtb-example-ce241829-dma-descriptor-chain](https://github.com/Infineon/mtb-example-ce241829-dma-descriptor-chain)" application with the desired name "DmaDescriptor" configured for the *KIT_PSOC4-HVMS-128K_LITE* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSOC4-HVMS-128K_LITE --app-id mtb-example-ce241829-dma-descriptor-chain --user-app-name DmaDescriptor --target-dir "C:/mtb_projects"
   ```
...
4. After programming, the application starts automatically and the strings(PSoC4_HVMS-DMACDC, CDAMD-SMVH_4CoSP) are displayed on the serial terminal as shown in **Figure 1**. If it is not correct, they are not displayed.
...
1. Locates transfer data (PING data: Source 1/Destination 1, and PONG data: Source 2/Destination 2) in SRAM
...
Document title: *CE241829* – *PSOC&trade; 4: DMA data transfer with descriptor chain*
